...
public class User  implements Serializable {//私有化变量
	...
	public String toString() {
		return "[账号=" + account + ", 密码=" + password + ", 开户名=" + name + ", 性别=" + gender
				+ ", 身份证号=" + cardid + ", 学历=" + education + ", 地址=" + address + ", 余额=" + balance
				+ "]\n";
	}
	...
	public User(String account,String  password,String name,String gender,
    		String cardid,String education,String address,double balance){//用以注册用户
    	this.account  = account;
    	this.password = password;
    	this.name     = name;
    	this.gender   = gender;
